 ...
 */
class CustomAttributesColumns implements ReportsColumns
{
    protected $amzImport;
   ...
   protected $prefix = 'custom_attribute_';
    ...
    public function getSelect(): array
    {
        ...
        for ($a = 0; $a < count($this->attributes); $a++) {
            ...
            AND kAttribut=" . $attribute->kAttribut . ") ) ";
        }
    ...
    {
        if($this->amzImport) {
            $ids = (new ImportProduct())->getCustomAttributes();
        } else {
            $ids = null;
        }
        return $this->repository->customAttributesColumnX04($ids);
    }
}