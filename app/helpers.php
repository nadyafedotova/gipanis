...
if (!function_exists('reports_parent')) {

    function reports_parent($group)
    {
        if (in_array($group, config('app.reports_group.amz'))){
            return 'amz';
        }
        return 'jtl';
    }
