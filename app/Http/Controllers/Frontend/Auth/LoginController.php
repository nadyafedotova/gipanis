...
class LoginController extends Controller
{
    ...
    protected function authenticated(Request $request, $user)
    {
        ...
        if (! $user->isConfirmed()) {
            ...
            if ($user->isPending()) {
                throw new GeneralException(__('exceptions.auth.confirmation.pending'));
            }

            // Otherwise see if they want to resent the confirmation e-mail

            throw new GeneralException(__('exceptions.auth.confirmation.resend', ['url' => route('auth.account.confirm.resend', $user->{$user->getUuidName()})]));
        ...
        session()->put('user'.$user->id.'_token', $token);
