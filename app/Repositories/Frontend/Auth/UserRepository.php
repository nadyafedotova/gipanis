...
class UserRepository extends BaseRepository
{
        ...
        if ($user->canChangeEmail()) {
            ...
            if ($user->email != $input['email']) {
                ...
                if ($this->getByColumn($input['email'], 'email')) {
                    throw new GeneralException(__('exceptions.auth.email_taken'));
                }
    ...
    public function confirm($code)
    {
        ...
        throw new GeneralException(__('exceptions.auth.confirmation.mismatch'));
    }
    ...
    public function findOrCreateProvider($data, $provider)
    {
        ...
        if (! $user) {
            ...
            if (! config('access.registration')) {
                throw new GeneralException(__('exceptions.auth.registration_disabled'));
            }
