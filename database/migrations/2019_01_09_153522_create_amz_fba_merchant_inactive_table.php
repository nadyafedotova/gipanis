...
class CreateAmzFbaMerchantInactiveTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('amz_fba_merchant_inactive', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('amz_fba_merchant_inactive');
    }
}
